...
public interface PersonsApi {
    ...
    default ResponseEntity<List<PersonDto>> personsGet(
        
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"yearsOld\" : 0, \"fullName\" : \"fullName\", \"birthDateStr\" : \"birthDateStr\" }, { \"yearsOld\" : 0, \"fullName\" : \"fullName\", \"birthDateStr\" : \"birthDateStr\" } ]";
